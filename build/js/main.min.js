...
var directionsBlock = document.querySelector('#directions'); // Список с карточками по маршрутам путешествия

var directionsList = directionsBlock.querySelector('#directions__list');
...
if (window.matchMedia('screen and (max-width: 1023px)').matches) {
  directionsList.addEventListener('click', function (evt) {
    var card = evt.target.closest('.card');
    var cardBack = evt.target.closest('.card-back');
...
var themeModeCheckbox = document.querySelector('[data-theme-mode]');
...
var approvalSection = document.querySelector('.approval');
...
var removeDarkTheme = function removeDarkTheme() {
...
if (themeModeCheckbox) {
  themeModeCheckbox.addEventListener('change', function () {
...
/* harmony import */ var _menu_burger_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_menu_burger_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _card_rotation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./card-rotation.js */ "./js/card-rotation.js");
/* harmony import */ var _card_rotation_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_card_rotation_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _dark_mode_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dark-mode.js */ "./js/dark-mode.js");
/* harmony import */ var _dark_mode_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_dark_mode_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _phone_input_mask_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./phone-input-mask.js */ "./js/phone-input-mask.js");
/* harmony import */ var _phone_input_mask_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_phone_input_mask_js__WEBPACK_IMPORTED_MODULE_5__);
...
var pageBody = document.body; // Для удобства поиска находим секцию header

var header = pageBody.querySelector('#header'); // Логотип сайта в планшетной/мобильной версии

var headerLogo = header.querySelector('#header__logo'); // Кнопка для открытия/закрытия меню

var burger = header.querySelector('#burger'); // Элемент - 'Бургер/Крестик'

var burgerMenu = burger.querySelector('#burger__menu'); // Навигация по сайту

var headerNav = header.querySelector('#header__nav'); // Навигация по сайту

var introBlock = pageBody.querySelector('#intro__block');
...
if (window.matchMedia('(max-width: 767px)').matches) {
  ...
  var clickOverlay = function clickOverlay(evt) {
    var elementsСlickArea = !evt.composedPath().includes(headerNav);
